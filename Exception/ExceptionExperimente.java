...
public class ExceptionExperimente
{
	...
	// Aufgabe 2
	public static int convert(double number) throws UnsupportedOperationException
	{
		if(Math.abs(number-Math.floor(number)) != 0 ) throw new UnsupportedOperationException() ;
		return (int)number ;
	}
	
	// Aufgabe 3
	public static int[] add(int[] array1, int[] array2) throws IllegalArgumentException
	{
